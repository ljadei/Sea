	...
	<div class="content">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light "
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav" style="margin-top: 20px;">
						<li class="nav-item col-lg-4"><a class="nav-link" href="#">资料
						</a></li>
						<li class="nav-item col-lg-4"><a class="nav-link" href="#">赛程
						</a></li>
						<li class="nav-item col-lg-4"><a class="nav-link" href="#">数据</a>
						</li>
						<li class="nav-item col-lg-4"><a class="nav-link" href="#">数据王</a>
						</li>
		...
		<div>
			...
			<div class="container" id="fengshu"
				>
				<p class="paiming">
				<h3>2021-2022 球队赛程</h3>
				</p>
			</div>
			<div class="container" id="fengshu"
				style="margin-top: -16px; color: #FFFFFF; text-align: center;">
				<table class="riqi" style="borde:solid thin red">
					<tr style="background-color: #032F4F;">
						<th style="width: 70px;">日期</th>
						<th style="width: 151px;">时间</th>
						<th style="width: 144px;">对手</th>
						<th style="width: 84px;">结果</th>
						<th style="width: 84px;">比分</th>
						<th style="width: 283px;">地点</th>
						<th style="width: 83px;">转播</th>
						<th style="width: 277px;">比赛连接</th>
					</tr>
					<tr bgcolor="gray">
						<td bgcolor="006BB7">三月</td>
						<td colspan="7" bgcolor="#006BB7"></td>
					</tr>
					<c:forEach var="lakersList" items="${lakersList2 }" varStatus="varindex">
					<c:if test="${varindex.index mod 2 eq 0 }">
						<tr bgcolor="#fff" style="color: #000" >
					</c:if>
					<c:if test="${varindex.index mod 2 ne 0 }">
						<tr bgcolor="#DCDCDC" style="color: #000">
					</c:if>
							<td>${lakersList.date }</td>
							<td>${lakersList.time }</td>
							<td><a href="#" style="color: blue">${lakersList.opponent }</a></td>
							<td>${lakersList.result }</td>
							<td>${lakersList.score }</td>
							<td>${lakersList.place }</td>
							<td>${lakersList.relay }</td>
							<td><a href="#">${lakersList.game_link }</a></td>
					</c:forEach>
					<tr bgcolor="gray">
						<td bgcolor="006BB7">四月</td>
						<td colspan="7" bgcolor="#006BB7"></td>
					</tr>
					<c:forEach var="lakersList" items="${lakersList3 }" varStatus="varindex">
					<c:if test="${varindex.index mod 2 eq 0 }">
						<tr bgcolor="#fff" style="color: #000">
					</c:if>
					<c:if test="${varindex.index mod 2 ne 0 }">
			...
			<div class="container" id="fengshu"
				style="margin-top: 0px; color: #FFFFFF; text-align: center;">
				<table class="riqi">
					<tr style="background-color: #032F4F;">
					...
					<tr bgcolor="gray">
						<td bgcolor="006BB7">十月</td>
						<td colspan="7" bgcolor="#006BB7"></td>
					</tr>
					<c:forEach var="lakersList" items="${lakersList9 }" varStatus="varindex">
					...
					<tr bgcolor="gray">
						<td bgcolor="006BB7">十二月</td>
						<td colspan="7" bgcolor="#006BB7"></td>
					</tr>
					<c:forEach var="lakersList" items="${lakersList11 }" varStatus="varindex">
					...
					<c:if test="${varindex.index mod 2 ne 0 }">
						...
						<tr bgcolor="gray">
						<td bgcolor="006BB7">一月</td>
						<td colspan="7" bgcolor="#006BB7"></td>
					</tr>
					<c:forEach var="lakersList" items="${lakersList }" varStatus="varindex">
					...
					<c:if test="${varindex.index mod 2 ne 0 }">
						...
						<tr bgcolor="gray">
						<td bgcolor="006BB7">二月</td>
						<td colspan="7" bgcolor="#006BB7"></td>
					</tr>
					<c:forEach var="lakersList" items="${lakersList1 }" varStatus="varindex">
