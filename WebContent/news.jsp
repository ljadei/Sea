	...
	<div id="all">
		...
		<div style="width: 100%; background-color: #552582;">
			<div style="background-color: #552582;" class="container">
				<div>
					...
					<a class="navbar-brand" href="playerqueyServlet"
						style="color: white;">&nbsp;球员&nbsp;</a> <a class="navbar-brand"
						href="queySevrlet" style="color: white;">&nbsp;赛程&nbsp;</a> <a
						class="navbar-brand" href="statistics.html" style="color: white;">&nbsp;统计&nbsp;</a>
		...
		<div class="container" style="position: relative; right: 50px">
			<div class="one">
				...
				<div class="image1">
					<label class="text1"><a
						href="https://china.nba.cn/article/index.htm?articleId=20220314113301">流言终结者：万次助攻只因选择了最简单的路？</a></label>
					<img src="img/news1.webp" width="200px" height="130px" /> <label
						class="label1">2022-03-14 11:49:50</label><label class="label2">评论(0)</label>
				</div>
				<div class="image2">
					<label class="text2"><a
						href="https://china.nba.cn/article/index.htm?articleId=20220314102500">里程碑！詹姆斯达成30000+10000+10000成就</a></label>
					<img src="img/news2.webp" width="200px" height="130px" /> <label
						class="label3">2022-03-14 11:45:10</label><label class="label4">评论(0)</label>
				</div>
				<div class="image3">
					<label class="text3"><a
						href="https://china.nba.cn/article/index.htm?articleId=20220314112900">布克30+10詹姆斯里程“悲”
							太阳大胜湖人</a></label> <img src="img/news3.webp" width="200px" height="130px" />
					<label class="label5">2022-03-14 11:28:38</label><label
						class="label6">评论(0)</label>
				</div>
				<div class="image4">
					<label class="text4"><a
						href="https://china.nba.cn/article/index.htm?articleId=20220312164200">沃格尔：勒布朗送上了一场史诗级别的表演</a></label>
					<img src="img/news4.jpg" width="200px" height="130px" /> <label
						class="label7">2022-03-12 16:42:55</label><label class="label8">评论(0)</label>
				</div>
				<div class="image5">
					<label class="text5"><a
						href="https://china.nba.cn/article/index.htm?articleId=20220312140500">詹姆斯50+7+6威少里程碑
							湖人轻取奇才</a></label> <img src="img/news5.webp" width="200px" height="130px" />
					<label class="label9">2022-03-12 15:09:16</label><label
						class="label10">评论(0)</label>
				</div>
				<div class="image6">
					<label class="text6"><a
						href="https://china.nba.cn/article/index.htm?articleId=20220310154400">詹姆斯：今天投篮不在状态
							我们犯错太多</a></label> <img src="img/news6.webp" width="200px" height="130px" />
					<label class="label11">2022-03-10 16:16:55</label><label
						class="label12">评论(0)</label>
				</div>
				<div class="image7">
					<label class="text7"><a
						href="https://china.nba.cn/article/index.htm?articleId=20220310115201">威少里程悲詹姆斯三双
							湖人加时不敌火箭</a></label> <img src="img/news7.webp" width="200px" height="130px" />
					<label class="label13">2022-03-10 11:52:33</label><label
						class="label14">评论(0)</label>
				</div>
				<div class="image8">
					<label class="text8"><a
						href="https://china.nba.cn/article/index.htm?articleId=20220308120700">穆雷准三双波波里程碑
							马刺主场力克湖人</a></label> <img src="img/news8.webp" width="200px" height="130px" />
					<label class="label15">2022-03-09 00:00:41</label><label
						class="label16">评论(0)</label>
				</div>
				<div class="image9">
					<label class="text9"><a
						href="https://china.nba.cn/article/index.htm?articleId=20220306173900">詹姆斯：我的风格适合任何一个篮球时代</a></label>
					<img src="img/news9.webp" width="200px" height="130px" /> <label
						class="label17">2022-03-06 17:39:06</label><label class="label18">评论(0)</label>
				</div>
				<div class="image10">
					<label class="text10"><a
						href="https://china.nba.cn/article/index.htm?articleId=20220306151500">数读詹姆斯56+10：一战打破多项纪录</a></label>
					<img src="img/news10.webp" width="200px" height="130px" /> <label
						class="label19">2022-03-06 16:27:17</label><label class="label20">评论(0)</label>
				</div>
				<div class="image11">
					<label class="text11"><a
						href="https://china.nba.cn/article/index.htm?articleId=20220306160101">地表最强37岁！老詹56+10打消一切质疑</a></label>
					<img src="img/news11.webp" width="200px" height="130px" /> <label
						class="label21">2022-03-06 16:01:58</label><label class="label22">评论(0)</label>
				</div>
				<div class="image12">
					<label class="text12"><a
						href="https://china.nba.cn/article/index.htm?articleId=20220306121200">詹姆斯赛季新高56分
							湖人逆转勇士结束连败</a></label> <img src="img/news12.webp" width="200px"
						height="130px" /> <label class="label23">2022-03-06
						14:02:03</label><label class="label24">评论(0)</label>
				</div>
				<div class="container">
